...
public class TableAdapter extends RecyclerView.Adapter<TableAdapter.MyViewHolder>  {
    ...
    public TableAdapter(Activity activity, List<String> list, ClickListenerInterface listener, RecyclerView recyclerView) {
    ...
    public TableAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        TableAdapter.MyViewHolder myViewHolder = new TableAdapter.MyViewHolder(view);

        return myViewHolder;
    }
    @RequiresApi(api = Build.VERSION_CODES.JELLY_BEAN)
    @Override
    public void onBindViewHolder(TableAdapter.MyViewHolder holder, final int position) {
